...
public class EventsFragment extends android.support.v4.app.Fragment {
    ...
    public void onResume() {
        ...
        if(EventsManager.sharedManager().getListNeedsRefresh() || SettingsProxy.sharedProxy().getInvolvesEvensListReloadByChangingStatusBusy() || SettingsProxy.sharedProxy().getInvolvesEvensListReloadByChangingIgnoreAllDayEvents()) {
