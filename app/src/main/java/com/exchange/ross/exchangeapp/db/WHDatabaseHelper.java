...
public class WHDatabaseHelper extends SQLiteOpenHelper
{
    ...
    private static final String DATABASE_CREATE1 = "CREATE TABLE IF NOT EXISTS Events (_id VARCHAR PRIMARY KEY, subject VARCHAR, location VARCHAR, required_attendees VARCHAR, optional_attendees VARCHAR, calendarName, start_date VARCHAR, end_date VARCHAR, body VARCHAR, account VARCHAR, modified VARCHAR, mute INTEGER)";
